(function () {
      ...
      var quizzes = [
        ...
        { question: "폭염 시간대 중 가장 더운 시간은?", choices: ["오후 2~5시", "새벽 5시", "오전 8시"], answer: 0, explanation: "햇볕의 열기가 가장 강한 시간대예요!" },
        ...
        { question: "집중호우 시 차량 운전 중 가장 위험한 행동은?", choices: ["속도를 줄인다", "침수 도로를 무리하게 통과한다", "라이트를 켠다"], answer: 1, explanation: "차가 물에 떠내려갈 수 있어서 절대 하면 안 돼요!" },
