(function () {
      ...
      var quizzes = [
        { question: "폭염 시 가장 중요한 행동은?", choices: ["수분섭취와 휴식", "참고 버티기", "두꺼운 옷 입기"], answer: 0, explanation: "수분 섭취 + 규칙적 휴식이 핵심!" },
        { question: "체감온도 33℃ 이상이면?", choices: ["쉬지 않고 작업", "물을 마시지 않기", "2시간마다 20분 휴식"], answer: 2, explanation: "2시간마다 20분, 시원한 곳에서 쉬세요." },
        { question: "폭염 때 시원한 물은?", choices: ["하루 한 번만 마신다", "충분히 자주 마신다", "뜨거운 커피만 마신다"], answer: 1, explanation: "갈증 전에 조금씩 자주! 1시간에 200mL 권장." },
        { question: "온열질환 의심 시 가장 먼저 할 일은?", choices: ["시원한 곳으로 이동", "더 오래 작업", "햇볕 아래 있기"], answer: 0, explanation: "즉시 시원한 곳으로! 체온을 낮추는 게 먼저." },
        { question: "폭염 작업 시 좋은 휴식 장소는?", choices: ["그늘 또는 시원한 곳", "뜨거운 바닥", "직사광선 아래"], answer: 0, explanation: "그늘·에어컨 공간에서 체온을 충분히 낮추세요." },
        { question: "폭염 예방에 도움이 되는 것은?", choices: ["보냉장구 착용", "두꺼운 담요", "밀폐된 공간"], answer: 0, explanation: "냉각조끼·아이스팩이 체표 온도를 낮춰줍니다." },
        { question: "체감온도 35℃ 이상 폭염경보 때 권고되는 것은?", choices: ["가장 더울 때 작업하기", "휴식 줄이기", "무더위 시간대 옥외작업 중지"], answer: 2, explanation: "오후 2~5시 옥외작업 중지! 법적 권고사항." },
        { question: "어지럽고 식은땀이 나면?", choices: ["더 빨리 움직이기", "즉시 쉬고 상태 확인", "물을 피하기"], answer: 1, explanation: "열탈진 초기 신호! 즉시 멈추고 시원한 곳으로." },
        { question: "몸을 식히는 데 좋은 방법은?", choices: ["뜨거운 장소로 이동", "햇볕 오래 쬐기", "시원한 물과 그늘"], answer: 2, explanation: "시원한 물 + 그늘 = 체온 효과적으로 낮아짐." },
        { question: "체감온도 38℃ 이상이면?", choices: ["긴급작업 외 옥외작업 중지", "휴식 없이 작업", "작업속도 높이기"], answer: 0, explanation: "긴급 제외, 모든 옥외 활동 즉시 중단!" },
        { question: "동료가 온열질환으로 의식이 이상하면?", choices: ["119에 신고", "혼자 쉬게 두기", "운동을 시키기"], answer: 0, explanation: "열사병 위험 신호! 즉시 119 신고하세요." },
        { question: "폭염 시 갈증이 나기 전에도 해야 할 일은?", choices: ["물을 참기", "카페인만 마시기", "물을 조금씩 자주 마시기"], answer: 2, explanation: "갈증 = 이미 탈수 시작. 미리 마시세요!" },
        { question: "폭염으로 어지럽고 메스꺼우면 해야 하는 행동은?", choices: ["더 빨리 움직이기", "시원한 곳으로 이동하기", "그냥 참기"], answer: 1, explanation: "열탈진 증상! 즉시 시원한 곳으로 이동하세요." },
        { question: "체감온도 33℃ 이상일 때 권장되는 것은?", choices: ["쉬지 않고 작업", "2시간마다 20분 이상 휴식", "물을 마시지 않기"], answer: 1, explanation: "2시간마다 최소 20분, 시원한 곳에서 쉬세요." },
        { question: "폭염 시 가장 피해야 하는 행동은?", choices: ["그늘에서 쉬기", "갈증날 때까지 물 안 마시기", "시원한 물 마시기"], answer: 1, explanation: "갈증까지 참으면 이미 탈수 상태입니다!" },
        { question: "온열질환 증상으로 맞는 것은?", choices: ["어지러움", "손발 얼음처럼 차가움", "콧물만 남"], answer: 0, explanation: "어지러움·두통·구역감이 주요 증상입니다." },
        { question: "폭염 작업 시 좋은 복장은?", choices: ["두꺼운 검은 옷", "통풍 잘 되는 밝은 옷", "패딩점퍼"], answer: 1, explanation: "밝은 색 통풍 옷 → 햇빛 반사 + 체온 억제." },
        { question: "온열질환자가 의식이 없다면?", choices: ["물을 마시게 한다", "잠깐 기다린다", "즉시 119에 신고한다"], answer: 2, explanation: "물 먹이면 기도 막힘! 즉시 119 신고하세요." },
        { question: "폭염 시간대 중 가장 더운 시간은?", choices: ["오후 2~5시", "새벽 5시", "오전 8시"], answer: 0, explanation: "오후 2~5시가 폭염 최대 위험 시간대!" },
        { question: "폭염 시 쉬기 좋은 장소는?", choices: ["햇볕 아래", "밀폐된 차량 안", "그늘지고 시원한 곳"], answer: 2, explanation: "통풍 잘 되는 그늘진 시원한 공간이 최선." },
        { question: "온열질환 예방에 도움이 되는 것은?", choices: ["규칙적인 휴식", "무리한 운동", "물 안 마시기"], answer: 0, explanation: "규칙적 휴식 → 체온 축적 방지가 핵심!" },
        { question: "폭염 속 차량 안이 위험한 이유는?", choices: ["너무 조용해서", "온도가 매우 빨리 올라가서", "창문이 많아서"], answer: 1, explanation: "10분 내 차 내부 60℃까지 온도 상승 가능!" },
        { question: "땀을 많이 흘렸을 때 가장 필요한 것은?", choices: ["수분 보충", "뜨거운 커피", "두꺼운 담요"], answer: 0, explanation: "물·이온음료로 수분과 전해질을 보충하세요." },
        { question: "폭염 시 위험할 수 있는 장소는?", choices: ["그늘막 아래", "환기 안 되는 밀폐공간", "에어컨 있는 실내"], answer: 1, explanation: "밀폐공간은 열 축적 → 온열질환 위험 극대!" },
        { question: "야외 작업 시 도움이 되는 것은?", choices: ["목도리", "냉각조끼", "털장갑"], answer: 1, explanation: "냉각조끼 → 체표 온도 낮춰 체온 상승 억제." },
        { question: "사업장에서 폭염 대비 제공해야 하는 것은?", choices: ["시원한 물", "뜨거운 국물", "겨울 외투"], answer: 0, explanation: "사업주 법적 의무: 시원한 음용수 무상 제공." },
        { question: "온열질환자가 의식이 없을 때 해야 하는 행동은?", choices: ["따뜻한 곳으로 이동", "몸 식혀주기", "억지로 물 먹이기"], answer: 1, explanation: "몸 식히며 즉시 119 신고! 물은 절대 금지." },
        { question: "몸을 식히는 방법으로 맞는 것은?", choices: ["두꺼운 옷 입기", "선풍기 사용하기", "햇볕 아래 있기"], answer: 1, explanation: "선풍기 바람 → 땀 증발 촉진 → 체온 하강." },
        { question: "폭염주의보 기준 체감온도는?", choices: ["33℃ 이상", "20℃ 이상", "15℃ 이하"], answer: 0, explanation: "체감 33℃ 이상, 2일 이상 지속 예상 시 발령." },
        { question: "폭염경보 기준 체감온도는?", choices: ["25℃ 이상", "40℃ 이상", "35℃ 이상"], answer: 2, explanation: "체감 35℃ 이상, 2일 이상 지속 예상 시 발령." },
        { question: "폭염 속 건강을 지키는 가장 좋은 습관은?", choices: ["무리하지 않기", "쉬지 않고 움직이기", "물 안 마시기"], answer: 0, explanation: "무리하지 않기! 온열질환 예방의 기본 원칙." },
        { question: "폭우가 올 때 가장 안전한 행동은?", choices: ["하천 근처로 구경 간다", "지하주차장으로 이동한다", "높은 곳이나 실내로 대피한다"], answer: 2, explanation: "하천·지하는 위험! 높은 곳·실내로 즉시 대피." },
        { question: "태풍이 올 때 창문 관리로 가장 올바른 것은?", choices: ["창문을 열어 둔다", "창문을 테이프로 보강하거나 단단히 닫는다", "창문을 조금만 열어둔다"], answer: 1, explanation: "테이프 보강 or 단단히 닫아 파편 비산 방지." },
        { question: "집중호우 시 차량 운전 중 가장 위험한 행동은?", choices: ["속도를 줄인다", "침수 도로를 무리하게 통과한다", "라이트를 켠다"], answer: 1, explanation: "침수 도로 절대 통과 금지! 차가 떠내려갑니다." },
        { question: "침수 위험이 있는 장소는?", choices: ["언덕 위 주택", "지하상가", "고층 아파트"], answer: 1, explanation: "지하상가는 빠르게 침수, 탈출 어려움!" },
        { question: "태풍 대비로 미리 해야 할 일은?", choices: ["창문 주변 정리 및 외부 물건 고정", "집 밖으로 나가 상황 확인", "가벼운 옷 준비만 한다"], answer: 0, explanation: "외부 물건 고정 필수! 날리면 인명 피해 유발." },
        { question: "호우 시 하천 근처에서 해야 할 행동은?", choices: ["사진 찍는다", "즉시 벗어난다", "물 흐름을 확인한다"], answer: 1, explanation: "수위 급상승! 즉시 하천에서 벗어나세요." },
        { question: "정전이 예상되는 태풍 상황에서 준비물은?", choices: ["손전등, 비상식량", "선풍기만 준비", "휴대폰만 충전"], answer: 0, explanation: "손전등·비상식량 필수! 배터리 라디오도 유용." },
        { question: "폭우 중 가장 위험한 장소는?", choices: ["대형마트 내부", "산사태 위험 지역", "카페"], answer: 1, explanation: "산사태 위험 지역! 토사가 갑자기 쏟아집니다." },
        { question: "침수된 길을 걸어야 한다면 가장 안전한 방법은?", choices: ["맨발로 빠르게 이동", "물 깊이를 확인하고 우회", "뛰어서 통과"], answer: 1, explanation: "깊이·오염 위험! 확인 후 가능하면 우회하세요." },
        { question: "재난 문자(긴급알림)를 받았을 때 해야 할 행동은?", choices: ["무시하고 하던 일 계속", "내용 확인 후 안내에 따라 행동", "바로 SNS에 공유만 한다"], answer: 1, explanation: "공식 위기 정보! 확인 후 즉시 안내에 따르세요." }
      ];
